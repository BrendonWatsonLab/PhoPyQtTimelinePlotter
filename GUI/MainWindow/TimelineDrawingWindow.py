...
class TimelineDrawingWindow(VideoTrackGroupOwningMixin, FileExportingMixin, MouseTrackingThroughChildrenMixin, DateTimeRenderMixin, DurationRepresentationMixin, AbstractDatabaseAccessingWindow):
    ...
    def initUI(self):
        ...
        def initUI_initMenuBar(self):
            ...
            self.ui.actionImport_general_h5_Data.triggered.connect(self.on_user_general_h5_data_load)
            self.ui.actionImport_general_npz_Data.triggered.connect(self.on_user_general_npz_data_load)
    ...
    def on_user_general_npz_data_load(self):
        ...
        path = QFileDialog.getOpenFileName(self, 'Open .npz Data File', os.getenv('HOME'), 'NPZ(*.npz)')
        importFilePath = path[0]
        if importFilePath == '':
            print("User canceled the import!")
            return
