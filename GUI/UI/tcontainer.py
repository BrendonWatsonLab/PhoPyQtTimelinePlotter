...
"""
class TContainer(ResizableContainerWidgetMixin, QWidget):
    ...
    def mousePressEvent(self, e: QtGui.QMouseEvent):
        if (self.resizableContainer_mousePressEvent(e)):
            if e.button() == QtCore.Qt.RightButton:
                self.popupShow(e.pos())
                e.accept()

    def keyPressEvent(self, e: QtGui.QKeyEvent):
        self.resizableContainer_keyPressEvent(e)
    ...
    def mouseMoveEvent(self, e: QtGui.QMouseEvent):
        ...
        self.resizableContainer_mouseMoveEvent(e)
