...
class PhoDurationEvent_Video(PhoDurationEvent):
    ...
    def __init__(
        ...
        super(PhoDurationEvent_Video, self).__init__(
    ...
    def paint(
        ...
        self.finalEventRect = super().paint(
        ...
        if self.isPlayingVideo:
            ...
            nowPlayingIndicatorHeight = (
                PhoDurationEvent_Video.IsPlayingIndicatorFractionOfHeight * height
            )
            ...
            painter.drawRoundedRect(
                ...
                width,
                nowPlayingIndicatorHeight,
                PhoDurationEvent_Video.RectCornerRounding,
                PhoDurationEvent_Video.RectCornerRounding,
            )
