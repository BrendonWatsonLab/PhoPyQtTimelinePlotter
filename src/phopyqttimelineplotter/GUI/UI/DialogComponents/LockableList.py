...
from PyQt5.QtWidgets import QMessageBox, QToolTip, QStackedWidget, QHBoxLayout, QVBoxLayout, QSplitter, QFormLayout, QLabel, QFrame, QPushButton, QTableWidget, QTableWidgetItem, QAbstractItemView
from PyQt5.QtWidgets import QApplication, QFileSystemModel, QTreeView, QWidget, QHeaderView, QInputDialog, QMenu
from PyQt5.QtGui import QPainter, QBrush, QPen, QColor, QFont, QIcon
from PyQt5.QtCore import Qt, QPoint, QRect, QObject, QEvent, pyqtSignal, pyqtSlot, QSize, QDir, QItemSelectionModel, QPersistentModelIndex
...
class LockableList(AbstractDatabaseAccessingWidget):
	...
	def initUI(self):
		if (LockableList.lockableListMainWidgetType == LockableListMainWidgetType.listWidget):
			self.ui.listView.setVisible(True)
			self.ui.tableView.setVisible(False)
			pass
		elif (LockableList.lockableListMainWidgetType == LockableListMainWidgetType.tableWidget):
