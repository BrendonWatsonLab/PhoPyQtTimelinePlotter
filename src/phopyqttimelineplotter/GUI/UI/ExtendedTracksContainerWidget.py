...
class ExtendedTracksContainerWidget(TickedTimelineDrawingBaseWidget):
    ...
    staticTimeDelininationTickLineProperties = TickProperties(
        QColor(187, 187, 187, 100), 0.8, Qt.SolidLine
    )
    staticTimeDelininationMinorTickLineProperties = TickProperties(
        QColor(187, 187, 187, 80), 0.4, Qt.SolidLine
    )
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(ExtendedTracksContainerWidget, self).__init__(
            totalStartTime,
            totalEndTime,
            totalDuration,
            duration,
    ...
    def draw_tick_lines(self, painter):
        ...
        painter.setPen(
            ExtendedTracksContainerWidget.staticTimeDelininationTickLineProperties.get_pen()
        )
        ...
        painter.setPen(
            ExtendedTracksContainerWidget.staticTimeDelininationMinorTickLineProperties.get_pen()
        )
