...
Welcome to `PhoPyQtTimelinePlotter` contributor's guide.
...
If you experience bugs or general issues with `PhoPyQtTimelinePlotter`, please have a look
...
You can help improve `PhoPyQtTimelinePlotter` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`PhoPyQtTimelinePlotter` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `PhoPyQtTimelinePlotter`'s files. While this mechanism can
...
```
conda create -n PhoPyQtTimelinePlotter python=3 six virtualenv pytest pytest-cov
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/PhoPyQtTimelinePlotter.git
   cd PhoPyQtTimelinePlotter
   ```
...
[repository]: https://github.com/<USERNAME>/PhoPyQtTimelinePlotter
[issue tracker]: https://github.com/<USERNAME>/PhoPyQtTimelinePlotter/issues
